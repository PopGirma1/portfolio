            ...
            <div className="profession-page">
                <div className="profession-content">
                    <div>
                        ...
                        <div id="row" className="profile">
                            <div className="profession-left">
                                <h2 className="title" id="title" >Employement History</h2>
                            </div>

                            <div className="profession-right">
                                <h5 className="sub-title">Ethiopian electric utility company(EEU).</h5>
                        ...
                        <div id="row" className="profile">
                            ...
                            <div className="profession-right">
                                ...
                                <span>
                                    ...
                                    🌟 Material UI Bootstrap Styled Components.<br />
                                    🌟 Cypress( JavaScript End to End Testing Framework).<br />
                                    🌟 Python ,Django, Flask, Java, Flutter, HTML5 and CSS.<br />
                                    🌟 Having additional skills in preparing SRS, SDS documentation, and Test plan.<br />
                                </span>
                            </div>
                        </div>
                        ...
                        <div id="row" className="profile">
                            <div className="profession-left">
                                <h2 className="title" id="title">Languages</h2>
                            </div>
